...
- Ninguna página del sitio nombra `oracle tarea`, el tracker ni el lenguaje de consultas (entrado en
  0.16.0–0.19.0). La guía `docs/12-tareas.md` sólo está enlazada desde `docs/README.md` y el README, en
