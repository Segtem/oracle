...
Este inventario documenta las fricciones ergonómicas reales encontradas al escribir y mantener medidas en Oracle. Cada entrada cuenta con evidencia empírica directa (archivo y línea, o comando y salida) proveniente de los proyectos activos ([Oracle](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo), [Jam](file:///home/workstation/Dev/jam/medidas), [LyraGASP](file:///home/workstation/Dev/games/unreal/LyraGASP/medidas)), la [guía de batalla naval](file:///home/workstation/TestOracleEjemplo/GUIA22.md), el [postmortem](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/estudios/POSTMORTEM-BATALLA-NAVAL-AGY.md) y los proyectos del laboratorio naval ([naval-0280](file:///home/workstation/Proyectos/batalla-naval/batalla-naval-lab/naval-0280) y [batalla_naval_test](file:///home/workstation/Dev/lab/batalla_naval_test)).
...
- **Evidencia citada**:
  - [`naval.alternancia_turnos.oracle`](file:///home/workstation/Proyectos/batalla-naval/batalla-naval-lab/naval-0280/catalogos/naval/naval.alternancia_turnos.oracle#L4):
    ```oracle
    donde t2.turno == mas(t1.turno, 1) y t1.tirador == t2.tirador
    ```
  - [`naval.turnos_sin_huecos.oracle`](file:///home/workstation/Proyectos/batalla-naval/batalla-naval-lab/naval-0280/catalogos/naval/naval.turnos_sin_huecos.oracle#L6):
    ```oracle
    donde registrados != mas(ultimo, 1)
    ```
  - [`nucleo/sintaxis.py`](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/nucleo/sintaxis.py#L208-L251): En el tokenizador `_tokenizar`, únicamente se reconocen comparadores (`==`, `!=`, `<=`, `>=`, `<`, `>`), lógicos (`y`, `o`, `no`), identificadores y llamadas con paréntesis. Cualquier caracter aritmético (`+`, `-`, `*`, `/`) no reconocido cae en [`_fallar(linea, col, "expresión", c)`](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/nucleo/sintaxis.py#L251), arrojando `ErrorSintaxis: se esperaba expresión; llegó +`.
  - [`catalogos/escalares.py`](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/catalogos/escalares.py#L16-L42): Se tuvieron que registrar funciones escalares explícitas `@escalar("mas")`, `@escalar("menos")` y `@escalar("por")` para suplir la falta de operaciones elementales.
...
- **Evidencia citada**:
  - [`GUIA22.md`](file:///home/workstation/TestOracleEjemplo/GUIA22.md#L671-L705):
  ...
  - [`naval.tiros_sin_repeticion.oracle`](file:///home/workstation/Proyectos/batalla-naval/batalla-naval-lab/naval-0280/catalogos/naval/naval.tiros_sin_repeticion.oracle#L4):
    ```oracle
...
- **Evidencia citada**:
  - [`GUIA22.md`](file:///home/workstation/TestOracleEjemplo/GUIA22.md#L794-L822):
    ...
    ```
  - [`GUIA22.md`](file:///home/workstation/TestOracleEjemplo/GUIA22.md#L908-L913):
  ...
  - [`TAREA.md`](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/tareas/20260923-120207-ergonomia/TAREA.md#L21-L23): Lo identifica expresamente como fricción previa.

### 2.2. Macros base (`ninguno` y `ninguno-par`) cerradas e incompatibles con `requiere` o filtros compuestos
- **Problema**: La macro estándar [`ninguno`](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/nucleo/macros/ninguno.oracle#L4-L11) y [`ninguno-par`](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/nucleo/macros/ninguno-par.oracle#L4-L14) tienen parámetros fijos y una plantilla rígida. Si una medida de invariante (`umbral <= 0`) necesita declarar una cláusula `requiere` para evitar falsos verdes ante evidencia vacía, o necesita pasos `sin` intermedios, no puede utilizar `ninguno`. Debe reescribirse completa como una definición canónica de 10 a 12 líneas.
- **Evidencia citada**:
  - [`nucleo/macros/ninguno.oracle`](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/nucleo/macros/ninguno.oracle#L4-L11):
    ```oracle
    defmacro ninguno(id, relacion, alias, predicado, porque, segun, ambito, alcance):
        medida $id:
            ...
            alcance $alcance
    ```
  - En [`naval-0280`](file:///home/workstation/Proyectos/batalla-naval/batalla-naval-lab/naval-0280/catalogos/naval/): Medidas como [`naval.flota_reglamentaria.oracle`](file:///home/workstation/Proyectos/batalla-naval/batalla-naval-lab/naval-0280/catalogos/naval/naval.flota_reglamentaria.oracle#L1-L12) o [`naval.turnos_sin_huecos.oracle`](file:///home/workstation/Proyectos/batalla-naval/batalla-naval-lab/naval-0280/catalogos/naval/naval.turnos_sin_huecos.oracle#L1-L12) debieron escribirse en sintaxis expandida únicamente para incluir `requiere celda_barco` o `requiere tiro`.
...
- **Evidencia citada**:
  - [`GUIA22.md`](file:///home/workstation/TestOracleEjemplo/GUIA22.md#L843-L844):
    > *«⚠️ El orden importa: `requiere` va DESPUÉS de `umbral`, no antes de `resumen`. Si lo ponés arriba, el catálogo no carga.»*
  - [`nucleo/sintaxis.py`](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/nucleo/sintaxis.py#L1224-L1255) (`_leer_medida`):
    El código ejecuta secuencialmente:
    1. `resumen = _leer_resumen(...)` ([L1226](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/nucleo/sintaxis.py#L1226))
    2. `_leer_umbral(...)` ([L1232](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/nucleo/sintaxis.py#L1232))
    3. `while ... startswith("requiere "):` ([L1237](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/nucleo/sintaxis.py#L1237))
    4. `if ... startswith("ambito "):` ([L1247](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/nucleo/sintaxis.py#L1247))
    5. `if ... startswith("alcance "):` ([L1254](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/nucleo/sintaxis.py#L1254))
...
- **Evidencia citada**:
  - [`catalogos/escalares.py`](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/catalogos/escalares.py#L55-L60):
    ```python
    @escalar("contiene")
    ...
    ```
  - [`nucleo/medida.py`](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/nucleo/medida.py#L408-L410):
    ```python
...
- **Evidencia citada**:
  - [`GUIA22.md`](file:///home/workstation/TestOracleEjemplo/GUIA22.md#L234-L251):
...
- **Evidencia citada**:
  - [`Dev/jam/medidas/oracle.json`](file:///home/workstation/Dev/jam/medidas/oracle.json#L8-L12):
    ```json
    ...
    ```
  - [`LyraGASP/medidas/oracle.json`](file:///home/workstation/Dev/games/unreal/LyraGASP/medidas/oracle.json#L6-L10):
    ```json
    "meta.toda_cantidad_comparada_tiene_unidad_derivable": {
      "desde": "2026-09-01",
...
- **Evidencia citada**:
  - [`Dev/jam/medidas/oracle.json`](file:///home/workstation/Dev/jam/medidas/oracle.json#L13-L17): Cota de 41 umbrales sin declarar en Jam.
  - [`LyraGASP/medidas/oracle.json`](file:///home/workstation/Dev/games/unreal/LyraGASP/medidas/oracle.json#L11-L15): Cota de 27 umbrales sin declarar en LyraGASP.
  - [`Dev/jam/medidas/catalogos/vault/vault.enlace_resuelve.json`](file:///home/workstation/Dev/jam/medidas/catalogos/vault/vault.enlace_resuelve.json#L8):
    ```json
    "sin_declarar",
    ```
  - [`LyraGASP/medidas/catalogos/recarga/recarga.montage_en_slot_cuerpo_entero.json`](file:///home/workstation/Dev/games/unreal/LyraGASP/medidas/catalogos/recarga/recarga.montage_en_slot_cuerpo_entero.json#L8):
    ```json
    "sin_declarar",
    ```
...
- **Evidencia citada**:
  - [`GUIA22.md`](file:///home/workstation/TestOracleEjemplo/GUIA22.md#L877):
    > *«(La superficie `.caso` no sabe escribir una relación vacía: se omite y listo.)»*
  - [`GUIA22.md`](file:///home/workstation/TestOracleEjemplo/GUIA22.md#L868-L875) (`corpus/partida/007-sin-disparos.caso`):
    ```
...
- **Evidencia citada**:
  - [`GUIA22.md`](file:///home/workstation/TestOracleEjemplo/GUIA22.md#L585-L620):
  ...
  - [`Dev/jam/medidas/oracle.json`](file:///home/workstation/Dev/jam/medidas/oracle.json#L18-L22): Cota de 16 medidas en Jam fijadas únicamente con evidencia fabricada.
  - [`LyraGASP/medidas/oracle.json`](file:///home/workstation/Dev/games/unreal/LyraGASP/medidas/oracle.json#L16-L20): Cota de 17 medidas en LyraGASP fijadas únicamente con evidencia fabricada.
  - [`wt-ergo/oracle.json`](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/oracle.json#L9-L14): 94 casos del propio Oracle en sombra porque declaran sólo `repo` y `commit` sin `comando` o `registro`.
...
- **Evidencia citada**:
  - [`GUIA22.md`](file:///home/workstation/TestOracleEjemplo/GUIA22.md#L711-L716):
    ```
...
- **Evidencia citada**:
  - [`GUIA22.md`](file:///home/workstation/TestOracleEjemplo/GUIA22.md#L964-L971):
  ...
  - [`RULE[Dev/jam/AGENTS.md]`](file:///home/workstation/Dev/jam/AGENTS.md):
    ...
    ```
  - [`Dev/jam/tools/relevo.py`](file:///home/workstation/Dev/jam/tools/relevo.py#L170):
    ```python
    ["oracle-diferencial", "--proyecto", "medidas", "--confiar-escalares"]
    ```
...
- **Evidencia citada**:
  - [`GUIA22.md`](file:///home/workstation/TestOracleEjemplo/GUIA22.md#L560-L566):
...
- **Evidencia citada**:
  - [`POSTMORTEM-BATALLA-NAVAL-AGY.md`](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/estudios/POSTMORTEM-BATALLA-NAVAL-AGY.md#L7-L9):
  ...
  - [`Dev/lab/batalla_naval_test/el_porque_de_agy.md`](file:///home/workstation/Dev/lab/batalla_naval_test/el_porque_de_agy.md#L11-L22):
  ...
  - [`tareas/20260919-135054-primer-valor/TAREA.md`](file:///tmp/claude-1000/-home-workstation-Dev-oracle/27d97167-363a-4362-9167-701b6c10974b/scratchpad/wt-ergo/tareas/20260919-135054-primer-valor/TAREA.md#L10-L14):
