...
Leé `vault-kb/planes/PLAN-0.16.0-TAREAS.md` e implementá P0 y P1 de punta a punta en este checkout:
...
- Primero escribí `vault-kb/estudios/0.16.0-tareas/AVANCE-AGY.md` con que recibiste el encargo, el primer paso
...
Terminá con `vault-kb/estudios/0.16.0-tareas/INFORME-AGY.md`: conducta implementada, decisiones, archivos,
