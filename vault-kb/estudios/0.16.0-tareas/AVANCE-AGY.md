...
Se recibe el encargo documentado en `vault-kb/estudios/0.16.0-tareas/ENCARGO-AGY.md` y definido en `vault-kb/planes/PLAN-0.16.0-TAREAS.md`.
...
- `vault-kb/estudios/0.16.0-tareas/AVANCE-AGY.md`: este registro vivo de progreso.
...
- `vault-kb/estudios/0.16.0-tareas/INFORME-AGY.md`: informe final con conducta implementada, decisiones, mediciones reales y secuencia reproducible de prueba.
...
- **Paso 4 (Cierre)**:
  1. Generar `vault-kb/estudios/0.16.0-tareas/INFORME-AGY.md` con las mediciones reales y comandos.
...
- [x] Redacción del informe final `vault-kb/estudios/0.16.0-tareas/INFORME-AGY.md`.
