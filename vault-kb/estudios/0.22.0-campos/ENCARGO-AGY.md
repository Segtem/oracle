...
por el dueño: [vault-kb/planes/PLAN-0.22.0-CAMPOS.md](../../planes/PLAN-0.22.0-CAMPOS.md). Revisa y verifica Claude.
...
`tests/test_campos_de_relaciones.py` y `tests/test_no_juzgaron.py`; y en `vault-kb/estudios/0.22.0-campos/` sus
