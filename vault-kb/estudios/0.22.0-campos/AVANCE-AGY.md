...
Plan: `vault-kb/planes/PLAN-0.22.0-CAMPOS.md`
Encargo: `vault-kb/estudios/0.22.0-campos/ENCARGO-AGY.md`
...
### Archivos a crear
- `vault-kb/estudios/0.22.0-campos/AVANCE-AGY.md` (este archivo)
...
- `vault-kb/estudios/0.22.0-campos/INFORME-AGY.md` (al finalizar)
