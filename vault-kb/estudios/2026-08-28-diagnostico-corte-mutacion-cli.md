...
> `vault-kb/estudios/2026-08-28-cli-tanda-1.md`.
>
> Cierre posterior: los 64 fueron tratados y la ronda final dio 308/308, sin vivos ni inconclusos.
> Ver `vault-kb/estudios/2026-08-28-cli-cerrada.md`.

## 1. Desacople: Corte de corrida vs. Sobrevivientes observados

El problema observado en `vault-kb/estudios/2026-08-28-la-cli-sin-vigilar.md` mezcla dos fenómenos independientes que deben separarse formalmente:
