...
Se ha recibido y leído íntegramente el encargo en `vault-kb/estudios/0.17.0-tatr/ENCARGO-AGY.md`, junto con:
- `vault-kb/planes/PLAN-0.16.0-TAREAS.md`
- `docs/12-tareas.md`
- `tools/tareas.py`
...
8. **`vault-kb/estudios/0.17.0-tatr/INFORME-AGY.md`**:
