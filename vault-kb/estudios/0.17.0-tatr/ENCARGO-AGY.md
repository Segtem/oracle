...
y trabajar con agy. Revisa y verifica Claude (Claude Code). Leer antes: `vault-kb/planes/PLAN-0.16.0-TAREAS.md`,
...
**TQL sigue fuera de alcance** (`vault-kb/planes/PLAN-0.16.0-TAREAS.md`, «un lenguaje nuevo de consultas como TQL»).
...
`docs/12-tareas.md`, nuevo `tests/test_tareas_tatr.py`, y en `vault-kb/estudios/0.17.0-tatr/` sus propios
...
`tools/verificar_instalacion.py`, `tools/mutar_codigo.py`, `.github/`, `vault-kb/estudios/0.16.0-tareas/`,
