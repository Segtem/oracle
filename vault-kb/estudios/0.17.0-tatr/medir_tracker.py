...
Ejemplo: python3 -B vault-kb/estudios/0.17.0-tatr/medir_tracker.py tareas_git --salida /tmp/ronda-git
...
PRIORIDADES = {
    ...
    for nombre in ("tareas", "tareas_contexto", "tareas_git", "tareas_hechos", "tareas_grafo")
}
