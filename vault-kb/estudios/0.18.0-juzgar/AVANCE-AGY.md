...
- **Propiedad estricta de archivos**:
  - Propiedad de AGY: `tools/juzgar.py` (nuevo), `tools/cli.py` (despacho, alias, ayudas), `tests/test_juzgar.py` (nuevo), sección en `docs/12-tareas.md`, `vault-kb/estudios/0.18.0-juzgar/AVANCE-AGY.md` e `INFORME-AGY.md`.
...
5. **`vault-kb/estudios/0.18.0-juzgar/INFORME-AGY.md` (Nuevo)**:
