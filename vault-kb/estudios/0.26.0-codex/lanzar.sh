...
#
#   vault-kb/estudios/0.26.0-codex/lanzar.sh <directorio-aislado> [modelo]
#
...
echo "entrega en $DESTINO — ahora: python3 vault-kb/estudios/0.26.0-codex/contrastar.py $DESTINO/evaluador.py"
