...
Este archivo, `ESPECIFICACION.md`, `docs/decisiones/DECISION-001-RELACIONES-COMO-BOLSAS.md` y
`docs/decisiones/DECISION-002-SIN-COMPOSICION-DE-MEDIDAS.md` son **todo** lo que hay en este directorio, y todo lo
