...
entera, `docs/mcp-contrato.md`, `tools/mcp.py`, `tools/juzgar.py`, `tests/test_mcp.py` y
...
- Tests nuevos, sí: `tests/test_mcp_027.py`. Usá sólo APIs que hayas leído en el código; no inventes
  nombres.
- Escribí `vault-kb/estudios/0.27.0-mcp/AVANCE-AGY.md` a medida que avanzás y, al final,
  `vault-kb/estudios/0.27.0-mcp/INFORME-AGY.md` con lo hecho, las decisiones y las contradicciones, sin
  afirmar verificaciones que no corriste.

## Contexto

`oracle-mcp` publica tres herramientas de sólo lectura. Su contrato normativo es
`docs/mcp-contrato.md`: el bloque JSON entre `<!-- herramientas-json:inicio -->` y
...
- `docs/mcp-contrato.md`: el bloque JSON y la prosa de lo nuevo.
