...
**`0 rojos`**. Detalle en
[`vault-kb/estudios/EL-ULTIMO-ROJO-DE-DECISION-004.md`](EL-ULTIMO-ROJO-DE-DECISION-004.md).
...
[`vault-kb/estudios/TRES-HUECOS-DECLARADOS-Y-NO-CERRADOS.md`](TRES-HUECOS-DECLARADOS-Y-NO-CERRADOS.md).
...
[`vault-kb/estudios/UN-HUECO-DECLARADO-SIGUE-SIENDO-UN-HUECO.md`](UN-HUECO-DECLARADO-SIGUE-SIENDO-UN-HUECO.md).
...
[`vault-kb/estudios/UNA-SOMBRA-APAGABA-TAMBIEN-EL-AVISO.md`](UNA-SOMBRA-APAGABA-TAMBIEN-EL-AVISO.md).
...
[`vault-kb/estudios/OBSERVAR-EL-PROPIO-ORACLE.md`](OBSERVAR-EL-PROPIO-ORACLE.md).
...
Detalle en [`vault-kb/estudios/EL-CENSO-CUENTA-Y-NO-JUZGA.md`](EL-CENSO-CUENTA-Y-NO-JUZGA.md).
...
[`vault-kb/estudios/LA-AUSENCIA-VISIBLE-NO-SE-PODIA-ESCRIBIR.md`](LA-AUSENCIA-VISIBLE-NO-SE-PODIA-ESCRIBIR.md).
...
[`vault-kb/estudios/OBSERVAR-O-CONSTRUIR-EL-BORDE.md`](OBSERVAR-O-CONSTRUIR-EL-BORDE.md), con las
...
`0.3`. Detalle en
[`vault-kb/estudios/EL-PAQUETE-MEDIA-CON-CINCO-DE-VEINTINUEVE.md`](EL-PAQUETE-MEDIA-CON-CINCO-DE-VEINTINUEVE.md).
...
ejecutan. Detalle en
[`vault-kb/estudios/UNA-HERRAMIENTA-QUE-SE-CAE-NO-INFORMA.md`](UNA-HERRAMIENTA-QUE-SE-CAE-NO-INFORMA.md).
...
[`vault-kb/estudios/PROCEDENCIA-DE-DONDE-SALIO-UN-CASO.md`](PROCEDENCIA-DE-DONDE-SALIO-UN-CASO.md).
...
2. `vault-kb/estudios/OBSERVAR-0.8.1-RECORRIDO.md` — la herramienta, qué se le encontró al experimento
...
4. `vault-kb/planes/PLAN-0.8.1-SENSOR.md` — las tres decisiones y cómo quedaron respondidas.
...
El usuario pidió seguir con `vault-kb/planes/PLAN-0.8.1-SENSOR.md`. Se ejecutó el sensor existente de dataset de
...
Detalle y siguientes pasos en `vault-kb/estudios/SENSOR-0.8.1-PRIMERA-CORRIDA.md`. El registrador conservado
...
El estado detallado y el inventario revisado están en `vault-kb/estudios/UMBRAL-0.8.0-REVISION.md`.
...
**Hecho:** las cuatro decisiones (`vault-kb/estudios/CANAL-DE-REPORTE.md`), y `oracle reportar`, que mide
...
## 0.8.0 — el umbral > 0 y el generador · `vault-kb/planes/PLAN-0.8.0-UMBRAL.md`
...
## 0.8.1 — que la evidencia venga del mundo · `vault-kb/planes/PLAN-0.8.1-SENSOR.md`
...
- **El ámbito `del_origen` de `meta.toda_medida_declara_su_ambito` es temporal** y nada registra
  cuándo debe volverse universal. Está anotado en `vault-kb/planes/PLAN-0.5.0-AMBITO.md`. El precedente de que esto
