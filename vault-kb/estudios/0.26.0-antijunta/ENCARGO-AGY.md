...
aprobado por el dueño: [vault-kb/planes/PLAN-0.26.0-ANTIJUNTA.md](../../planes/PLAN-0.26.0-ANTIJUNTA.md). Revisa, mide y
corta Claude.
...
`tests/test_antijunta.py` (nuevo), y en `vault-kb/estudios/0.26.0-antijunta/` sus `AVANCE-AGY.md` (primero) e
