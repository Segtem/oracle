...
**Plan base**: `vault-kb/planes/PLAN-0.21.0-MUTANTE.md`  
**Encargo**: `vault-kb/estudios/0.21.0-mutante/ENCARGO-AGY.md`  
...
4. `vault-kb/estudios/0.21.0-mutante/INFORME-AGY.md`:
