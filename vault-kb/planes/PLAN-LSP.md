...
**Estado:** diseño, sin construir (2026-08-31). Sucede a `vault-kb/planes/PLAN-IDE.md`, cuyo primer punto
...
De `vault-kb/planes/PLAN-IDE.md`, y vale igual acá:
...
El LSP es el único de los tres trabajos de `vault-kb/planes/PLAN-IDE.md` que **se acopla a la superficie**. La
