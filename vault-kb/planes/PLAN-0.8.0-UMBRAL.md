...
**Sale de:** `vault-kb/estudios/EL-UMBRAL-MAYOR-QUE-CERO.md`, y de un defecto real que ya causó.

**Revisión contra el código actual:** [`vault-kb/estudios/UMBRAL-0.8.0-REVISION.md`](../estudios/UMBRAL-0.8.0-REVISION.md).
