...
python -m unittest discover -s tests -t . -q     # 250 tests, cero dependencias
```
...
> el alcance actual incluye los perfiles y suma 1108 sitios. Las primeras seis particiones fijaron
> 179/179; quedan 929 sitios por ejecutar y triage, no “113” trasladados por inercia.
...
- **El baseline actual de código**: seis particiones ya están en 179/179; quedan 929 sitios del
  denominador de 1108 por ejecutar y triar. El antiguo 503/616 quedó vencido al mover código a perfiles.
