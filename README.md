...
<!-- negativas:inicio -->
En este corte hay 10936 líneas de lenguaje y **452 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- cifras:inicio -->
2573 tests · 1010/1010 mutantes de medida · **8619 sitios de mutación de código** (8381 + 238 del motor Python).
<!-- cifras:fin -->
