...
<!-- negativas:inicio -->
En este corte hay 6581 líneas de lenguaje y **260 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**6581 líneas de lenguaje** (`nucleo/`, código y macros) y **260 negativas explícitas** (`raise`). Contra las 38 medidas universales escritas en él (236 líneas): **27,9 a 1**. 29 de las 38 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
675 tests · 568/568 mutantes de medida · **3006 sitios de mutación de código** (2801 + 205 del motor Python).
<!-- cifras:fin -->
