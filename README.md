...
<!-- negativas:inicio -->
En este corte hay 6530 líneas de lenguaje y **256 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**6530 líneas de lenguaje** (`nucleo/`, código y macros) y **256 negativas explícitas** (`raise`). Contra las 38 medidas universales escritas en él (236 líneas): **27,7 a 1**. 29 de las 38 pasan por una macro.
<!-- escala:fin -->
