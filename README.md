...
<!-- negativas:inicio -->
En este corte hay 6892 líneas de lenguaje y **281 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**6892 líneas de lenguaje** (`nucleo/`, código y macros) y **281 negativas explícitas** (`raise`). Contra las 40 medidas universales escritas en él (248 líneas): **27,8 a 1**. 30 de las 40 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
690 tests · 595/595 mutantes de medida · **3089 sitios de mutación de código** (2884 + 205 del motor Python).
<!-- cifras:fin -->
