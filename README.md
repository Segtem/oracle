...
<!-- negativas:inicio -->
En este corte hay 5781 líneas de lenguaje y **256 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**5781 líneas de lenguaje** (`nucleo/`, código y macros) y **256 negativas explícitas** (`raise`). Contra las 37 medidas universales escritas en él (225 líneas): **25,7 a 1**. 29 de las 37 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
661 tests · 547/547 mutantes de medida · **2431 sitios de mutación de código** (2226 + 205 del motor Python).
<!-- cifras:fin -->
