...
<!-- negativas:inicio -->
En este corte hay 3084 líneas de lenguaje y **173 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**3084 líneas de lenguaje** (`nucleo/`, código y macros) y **173 negativas explícitas** (`raise`). Contra las 24 medidas universales escritas en él (220 líneas): **14,0 a 1**. 21 de las 24 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
413 tests · 206/206 mutantes de medida · **1263 sitios de mutación de código** (1058 + 205 del motor Python).
<!-- cifras:fin -->
