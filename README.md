...
<!-- negativas:inicio -->
En este corte hay 5796 líneas de lenguaje y **256 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**5796 líneas de lenguaje** (`nucleo/`, código y macros) y **256 negativas explícitas** (`raise`). Contra las 38 medidas universales escritas en él (236 líneas): **24,6 a 1**. 29 de las 38 pasan por una macro.
<!-- escala:fin -->
...
<!-- corpus:inicio -->
**106 casos**: 71 defectos y 35 verdes correctos. De los defectos, 68 deben ponerse en rojo · 0 huecos abiertos · 2 resueltos conservados · 1 límite humano. Por etiqueta: 66 falsos verdes, 2 falsos rojos, 1 conclusión causal incorrecta pese a una medida correcta y 2 deudas de diseño. Por procedencia: 63 observada, 37 construida, 6 generada y 0 sin declarar.
<!-- corpus:fin -->

<!-- cifras:inicio -->
664 tests · 568/568 mutantes de medida · **2434 sitios de mutación de código** (2229 + 205 del motor Python).
<!-- cifras:fin -->
