...
<!-- negativas:inicio -->
En este corte hay 7212 líneas de lenguaje y **291 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- deteccion:inicio -->
Los 75 casos no observacionales salieron a la luz por vías que no aceptan el verde nominal: 55 la mutación, 12 una persona, 4 la casualidad, 4 una herramienta ajena.
<!-- deteccion:fin -->
...
<!-- escala:inicio -->
**7212 líneas de lenguaje** (`nucleo/`, código y macros) y **291 negativas explícitas** (`raise`). Contra las 40 medidas universales escritas en él (244 líneas): **29,6 a 1**. 34 de las 40 pasan por una macro.
<!-- escala:fin -->
...
<!-- corpus:inicio -->
**118 casos**: 76 defectos y 42 verdes correctos. De los defectos, 73 deben ponerse en rojo · 0 huecos abiertos · 2 resueltos conservados · 1 límite humano. Por etiqueta: 71 falsos verdes, 2 falsos rojos, 1 conclusión causal incorrecta pese a una medida correcta y 2 deudas de diseño. Por procedencia: 75 observada, 37 construida, 6 generada y 0 sin declarar.
<!-- corpus:fin -->

<!-- cifras:inicio -->
692 tests · 595/595 mutantes de medida · **3260 sitios de mutación de código** (3055 + 205 del motor Python).
<!-- cifras:fin -->
