...
<!-- negativas:inicio -->
En este corte hay 10928 líneas de lenguaje y **451 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**10928 líneas de lenguaje** (`nucleo/`, código y macros) y **451 negativas explícitas** (`raise`). Contra las 62 medidas universales escritas en él (443 líneas): **24,7 a 1**. 53 de las 62 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
2561 tests · 1010/1010 mutantes de medida · **8606 sitios de mutación de código** (8368 + 238 del motor Python).
<!-- cifras:fin -->
