...
<!-- negativas:inicio -->
En este corte hay 10466 líneas de lenguaje y **436 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**10466 líneas de lenguaje** (`nucleo/`, código y macros) y **436 negativas explícitas** (`raise`). Contra las 61 medidas universales escritas en él (437 líneas): **23,9 a 1**. 52 de las 61 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
2146 tests · 984/984 mutantes de medida · **7411 sitios de mutación de código** (7200 + 211 del motor Python).
<!-- cifras:fin -->
