...
<!-- negativas:inicio -->
En este corte hay 6509 líneas de lenguaje y **256 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**6509 líneas de lenguaje** (`nucleo/`, código y macros) y **256 negativas explícitas** (`raise`). Contra las 37 medidas universales escritas en él (225 líneas): **28,9 a 1**. 29 de las 37 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
667 tests · 547/547 mutantes de medida · **2979 sitios de mutación de código** (2774 + 205 del motor Python).
<!-- cifras:fin -->
