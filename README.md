...
<!-- negativas:inicio -->
En este corte hay 10827 líneas de lenguaje y **444 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**10827 líneas de lenguaje** (`nucleo/`, código y macros) y **444 negativas explícitas** (`raise`). Contra las 62 medidas universales escritas en él (443 líneas): **24,4 a 1**. 53 de las 62 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
2428 tests · 1010/1010 mutantes de medida · **7909 sitios de mutación de código** (7675 + 234 del motor Python).
<!-- cifras:fin -->
