...
<!-- negativas:inicio -->
En este corte hay 5676 líneas de lenguaje y **256 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**5676 líneas de lenguaje** (`nucleo/`, código y macros) y **256 negativas explícitas** (`raise`). Contra las 37 medidas universales escritas en él (225 líneas): **25,2 a 1**. 29 de las 37 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
551 tests · 547/547 mutantes de medida · **2280 sitios de mutación de código** (2075 + 205 del motor Python).
<!-- cifras:fin -->
