...
<!-- negativas:inicio -->
En este corte hay 4747 líneas de lenguaje y **226 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**4747 líneas de lenguaje** (`nucleo/`, código y macros) y **226 negativas explícitas** (`raise`). Contra las 33 medidas universales escritas en él (298 líneas): **15,9 a 1**. 26 de las 33 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
462 tests · 406/406 mutantes de medida · **1909 sitios de mutación de código** (1704 + 205 del motor Python).
<!-- cifras:fin -->
