...
<!-- negativas:inicio -->
En este corte hay 3827 líneas de lenguaje y **202 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**3827 líneas de lenguaje** (`nucleo/`, código y macros) y **202 negativas explícitas** (`raise`). Contra las 33 medidas universales escritas en él (302 líneas): **12,7 a 1**. 26 de las 33 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
445 tests · 406/406 mutantes de medida · **1384 sitios de mutación de código** (1179 + 205 del motor Python).
<!-- cifras:fin -->
