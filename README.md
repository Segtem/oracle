...
<!-- negativas:inicio -->
En este corte hay 10824 líneas de lenguaje y **444 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**10824 líneas de lenguaje** (`nucleo/`, código y macros) y **444 negativas explícitas** (`raise`). Contra las 62 medidas universales escritas en él (443 líneas): **24,4 a 1**. 53 de las 62 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
2411 tests · 1010/1010 mutantes de medida · **7894 sitios de mutación de código** (7660 + 234 del motor Python).
<!-- cifras:fin -->
