...
python -m unittest discover -s tests -t . -q     # 263 tests, cero dependencias
```
...
> el alcance actual incluye los perfiles y suma 1099 sitios. Ocho particiones fijaron
> 250/250; quedan 849 sitios por ejecutar y triage, no “113” trasladados por inercia.
...
- **El baseline actual de código**: ocho particiones ya están en 250/250; quedan 849 sitios del
