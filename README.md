...
<!-- negativas:inicio -->
En este corte hay 10183 líneas de lenguaje y **427 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**10183 líneas de lenguaje** (`nucleo/`, código y macros) y **427 negativas explícitas** (`raise`). Contra las 60 medidas universales escritas en él (431 líneas): **23,6 a 1**. 51 de las 60 pasan por una macro.
<!-- escala:fin -->
...
<!-- corpus:inicio -->
**205 casos**: 123 defectos y 82 verdes correctos. De los defectos, 116 deben ponerse en rojo · 0 huecos abiertos · 5 resueltos conservados · 2 límite humano. Por etiqueta: 117 falsos verdes, 2 falsos rojos, 1 conclusión causal incorrecta pese a una medida correcta y 3 deudas de diseño. Por procedencia: 112 observada, 87 construida, 6 generada y 0 sin declarar.
<!-- corpus:fin -->

<!-- cifras:inicio -->
2121 tests · 971/971 mutantes de medida · **7382 sitios de mutación de código** (7171 + 211 del motor Python).
<!-- cifras:fin -->
