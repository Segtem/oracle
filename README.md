...
<!-- negativas:inicio -->
En este corte hay 3742 líneas de lenguaje y **201 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**3742 líneas de lenguaje** (`nucleo/`, código y macros) y **201 negativas explícitas** (`raise`). Contra las 33 medidas universales escritas en él (302 líneas): **12,4 a 1**. 26 de las 33 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
449 tests · 406/406 mutantes de medida · **1346 sitios de mutación de código** (1141 + 205 del motor Python).
<!-- cifras:fin -->
