...
<!-- escala:inicio -->
**5100 líneas de lenguaje** (`nucleo/`, código y macros) y **235 negativas explícitas** (`raise`). Contra las 33 medidas universales escritas en él (203 líneas): **25,1 a 1**. 26 de las 33 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
499 tests · 406/406 mutantes de medida · **2054 sitios de mutación de código** (1849 + 205 del motor Python).
<!-- cifras:fin -->
