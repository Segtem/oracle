...
<!-- negativas:inicio -->
En este corte hay 10804 líneas de lenguaje y **443 negativas explícitas** (`raise`).
<!-- negativas:fin -->
...
<!-- escala:inicio -->
**10804 líneas de lenguaje** (`nucleo/`, código y macros) y **443 negativas explícitas** (`raise`). Contra las 62 medidas universales escritas en él (443 líneas): **24,4 a 1**. 53 de las 62 pasan por una macro.
<!-- escala:fin -->
...
<!-- cifras:inicio -->
2430 tests · 1010/1010 mutantes de medida · **7919 sitios de mutación de código** (7685 + 234 del motor Python).
<!-- cifras:fin -->
