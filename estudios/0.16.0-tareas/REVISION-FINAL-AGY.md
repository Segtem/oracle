...
A continuación se presentan los hallazgos de la revisión de solo lectura, contrastando [`docs/12-tareas.md`](../../docs/12-tareas.md), [`PLAN-0.16.0-TAREAS.md`](../../PLAN-0.16.0-TAREAS.md), [`estudios/0.16.0-tareas/INFORME-AGY.md`](../../estudios/0.16.0-tareas/INFORME-AGY.md), [`tools/tareas.py`](../../tools/tareas.py) y las pruebas del CLI:

---

### 1. Discrepancias de Roadmap y alcance futuro (INFORME-AGY vs PLAN)

* **Ruta y líneas**: [`estudios/0.16.0-tareas/INFORME-AGY.md#L219-L224`](../../estudios/0.16.0-tareas/INFORME-AGY.md#L219-L224)
* **Discrepancia**: El informe final describe erróneamente P2 como *«Proyección indexada en base de datos local SQLite»* y P3 como *«Sincronización colaborativa y ganchos de integración con Git»*. En [`PLAN-0.16.0-TAREAS.md#L119-L154`](../../PLAN-0.16.0-TAREAS.md#L119-L154), el alcance real es:
...
* **Corrección propuesta**: Ajustar la Sección 7 de `INFORME-AGY.md` alineando los resúmenes de P2 y P3 con las definiciones de `PLAN-0.16.0-TAREAS.md`.

---

### 2. Discrepancia en el conteo de tests y estado de archivos (INFORME-AGY vs árbol real)

* **Ruta y líneas**: [`estudios/0.16.0-tareas/INFORME-AGY.md#L17`](../../estudios/0.16.0-tareas/INFORME-AGY.md#L17), [`L122`](../../estudios/0.16.0-tareas/INFORME-AGY.md#L122), [`L124`](../../estudios/0.16.0-tareas/INFORME-AGY.md#L124), [`L142-L143`](../../estudios/0.16.0-tareas/INFORME-AGY.md#L142-L143)
* **Discrepancia**:
