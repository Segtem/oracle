...
Plan: [PLAN-0.19.0-TQL.md](../../PLAN-0.19.0-TQL.md). Revisa y verifica Claude.
...
nueva y la actualización de «Diferencias con tatr» en `docs/12-tareas.md`; y en `estudios/0.19.0-tql/`
