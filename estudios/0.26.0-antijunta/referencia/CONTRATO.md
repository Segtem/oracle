...
Este archivo, `ESPECIFICACION.md`, `DECISION-001-RELACIONES-COMO-BOLSAS.md`,
`DECISION-002-SIN-COMPOSICION-DE-MEDIDAS.md`, `evaluador.py`, `test_evaluador.py` y `DECISIONES.md`
