# Una implementación 0.7 hecha de cero, por un tercer autor
...
álgebra 0.6 (2026-08-24) y agy la re-derivó contra 0.7 (2026-09-15) **mirando la de Codex**. Eso deja
...
Lo que falta es una implementación 0.7 escrita **sin ver ninguna otra**, sólo con la especificación
vigente.
...
estudios/0.26.0-codex/lanzar.sh /ruta/fuera/del/repo/codex-07 [modelo]

# 2. el contraste contra la referencia actual
python3 estudios/0.26.0-codex/contrastar.py /ruta/fuera/del/repo/codex-07/evaluador.py
```
