...
estudios/0.26.0-codex/lanzar.sh /ruta/fuera/del/repo/codex-08 [modelo]

# 2. el contraste contra la referencia actual
python3 estudios/0.26.0-codex/contrastar.py /ruta/fuera/del/repo/codex-08/evaluador.py
```
