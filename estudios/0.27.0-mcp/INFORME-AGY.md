...
4. **Contrato normativo y documentación**: Actualización completa del bloque JSON en `estudios/MCP-CONTRATO.md` (idéntico a `mcp.HERRAMIENTAS`), incorporación de prosa explicativa, ampliación de la tabla de códigos de error de dominio y adición de la sección de MCP en `README.md`.
...
### `estudios/MCP-CONTRATO.md` (Contrato Normativo)
