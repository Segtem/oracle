...
Plan aprobado por el dueño: [PLAN-0.21.0-MUTANTE.md](../../PLAN-0.21.0-MUTANTE.md). Revisa y verifica
Claude.
...
`estudios/0.21.0-mutante/` sus `AVANCE-AGY.md` (primero, con el plan de archivos) e `INFORME-AGY.md`
(al final).
