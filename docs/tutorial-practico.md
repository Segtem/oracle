...
Guía complementaria al estudio integral que genera `oracle-estudio --archivo ORACLE-PARA-NOTEBOOKLM.md` (filosofía,
...
- El estudio integral completo (filosofía, especificación formal, auditoría, historia de decisiones)
  se genera con `oracle-estudio --archivo ORACLE-PARA-NOTEBOOKLM.md` desde el árbol.
- La guía de referencia oficial para escribir una medida: `docs/03-escribir-una-medida.md`.
