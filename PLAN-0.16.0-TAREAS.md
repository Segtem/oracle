...
Su avance debe quedar en `estudios/0.16.0-tareas/AVANCE-AGY.md`; el resultado y comandos de
verificación, en `estudios/0.16.0-tareas/INFORME-AGY.md`. Ambos fueron recibidos y revisados.
